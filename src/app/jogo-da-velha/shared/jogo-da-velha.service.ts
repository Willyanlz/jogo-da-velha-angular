...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializa o tabuleiro do jogo com vazio para todas posições.
   * 
   * @returns void
   */
  ...
  /**
  * Realiza uma jogada dando as coordenadas do tabuleiro.
  * 
  * @param posX 
  * @param posY 
  * @returns void
  ...
  */
  ...
  /**
   * obtém jogada válida para vitoria do jogador ou cpu
   * 
  ...
  /**
   * verifica se X deve ser exibida na coordenada informada
   * 
   * @param posX number
   * @param posY number
   * @returns boolean
  ...
  /**
   * verifica se O deve ser exibida na coordenada informada
   * 
   * @param posX number
   * @param posY number
   * @returns boolean
  ...
  /**
   * verfica se teve vitória na coordenada informada
   * 
   * 
   */
  ...
  /**
   * Inicia um novo jogo e exibe o tabuleiro
   * 
   * @returns void
   */
